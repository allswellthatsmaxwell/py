...
export function TopicsList({
                               ...
                               entriesDayCounts,
                               setEntriesDayCounts,
                               entriesDayCountsChanged,
                               setEntriesDayCountsChanged
                           }) {
    ...
    function getEntriesDayCounts(topics_snapshot) {
        ...
        console.log("entriesDayCountsChanged: ", entriesDayCountsChanged);
        if (entriesDayCountsChanged) {
            ...
            setEntriesDayCountsChanged(false);
        } else {
            return entriesDayCounts;
        }
    }
